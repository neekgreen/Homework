...
//using RezAgent.DependencyResolution;
//using MediatR;
//using RezAgent.Models;
...
//                {
//                    var entry = (dbContext as DocumentDbContext).ChangeTracker.Entries().FirstOrDefault(entityEntry => entityEntry.Entity == entity);
//                    if (entry == null)
//                    {
...
//        {
//            var dbContext = scope.GetInstance<IDocumentDbContext>();
//            try
//            {
...
//        public void Do(Action<IDocumentDbContext> action)
//        {
//            var dbContext = scope.GetInstance<IDocumentDbContext>();
//            try
//            {
...
//        public void DoClean(Action<IDocumentDbContext> action)
//        {
...
//            var context = scope.GetInstance<IDocumentDbContext>();
